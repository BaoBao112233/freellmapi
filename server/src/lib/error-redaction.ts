...
const REDACTIONS: Array<[RegExp, string]> = [
  ...
  // `freellmapi-` is the pre-rename prefix: keys issued before Drawin AI stay
  // valid, so they must stay redactable.
  [/\b(?:drawin|freellmapi)-[A-Za-z0-9_-]{8,}\b/g, '[redacted-key]'],
